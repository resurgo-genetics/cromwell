...
import wom.types.{WdlFileType, WdlIntegerType, WdlOptionalType}
import wom.values.{WdlFile, WdlFloat, WdlInteger, WdlOptionalValue, WdlSingleFile, WdlString, WdlValue}
